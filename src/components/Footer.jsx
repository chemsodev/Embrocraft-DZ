    ...
    <footer className="bg-gray-100 text-black py-8">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <nav className="flex space-x-4 text-md font-semibold">
          ...
          <Link href="#clothing-styles" className="hover:text-[#8C2F39]">Styles</Link>
        </nav>

        <div className="flex space-x-4">
          <Link href="#" aria-label="Facebook" >
            <FaFacebookF  className='fill-blue-600 hover:fill-gray-400 h-6 w-6'/>
          </Link>
          <Link href="#" aria-label="Instagram">
            <FaInstagram className='fill-orange-500 hover:fill-gray-400 h-6 w-6' />
          </Link>
          <Link href="#" aria-label="Twitter">
            <FaTwitter  className='fill-blue-500 hover:fill-gray-400 h-6 w-6' />
          </Link>
          <Link href="#" aria-label="YouTube">
            <FaYoutube  className='fill-red-500 hover:fill-gray-400 h-6 w-6'/>
          </Link>
        </div>
      </div>
